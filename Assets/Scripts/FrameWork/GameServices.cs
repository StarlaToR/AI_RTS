...
public class GameServices : MonoBehaviour
{
    ...
    [SerializeField] FactoryDataScriptable[] factoriesData;
    [SerializeField] UnitDataScriptable[] unitsData;

    public static FactoryDataScriptable[] GetFactoriesData { get { return Instance.factoriesData; } }
    public static UnitDataScriptable[] GetUnitsData { get { return Instance.unitsData; } }
